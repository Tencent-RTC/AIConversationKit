...
//  AIConversationKit
//
//  Created by jeremiawang on 2025/7/18.
//
...
class Logger {
    ...
    private static let LOG_KEY_PARAMS_MODULE_VALUE = "[aic-api]"

    private func `init`() {}
    enum AIConversationLogLevel: Int {
        case error = 2
        case warn = 1
        case info = 0
    }
    ...
    private static func log(level: AIConversationLogLevel = .info, file: String, line: String, _ messages: [String]) {

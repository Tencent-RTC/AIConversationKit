 ...
 * Before going online officially, please migrate the UserSig calculation code and
 * Keys to your backend server to avoid traffic theft caused by encryption key leakage.
 */
let SECRETKEY = ""
